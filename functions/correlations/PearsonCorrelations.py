...
class PearsonCorrelations(FeaturesHandling):
    ...
    def one_to_one(
        self, featureAnalyze, featureCorrelation, with_plot=False, desc=False
    ):
            ...
            [
                {
                    ...
                    "pearson_stat": pearson_stat if not desc else self._interpret_pearson_value(pearson_stat),
                    "p_value": p_value,
                    "evidence_MAR": p_value < self.alpha,
                }
            ]
